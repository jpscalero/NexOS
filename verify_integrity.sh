...
echo ""
echo "--- Build Hooks ---"
for hook in 00-system-branding 01-metasploit 02-user-setup 03-service-config 04-kde-custom 05-premium-ui 06-remove-debian-branding 10-force-nexos-branding 99-cleanup; do
